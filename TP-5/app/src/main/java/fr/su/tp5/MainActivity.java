...
public class MainActivity extends ActionBarActivity {
    ...
    private ArrayList<Contact_model> readContacts() {
        ...
        Cursor contactsCursor = getContentResolver().query(uri, null, null, null, 	ContactsContract.Contacts.DISPLAY_NAME + " ASC "); // Return all contacts name containing in URI in ascending order
// Move cursor at starting
        if (contactsCursor.moveToFirst()) {
            do {
                ...
                Cursor dataCursor = getContentResolver().query(dataUri, null, ContactsContract.Data.CONTACT_ID + " = " + contctId, null, null);// Return data cusror represntative to contact ID
                ...
                // This strings stores all contact numbers, email and other details like nick name, company etc.
                ...
                if (dataCursor.moveToFirst()) {
                    ...
                    contactList.add(new Contact_model(Long.toString(contctId),
                            displayName, contactNumbers, contactEmailAddresses, photoPath, contactOtherDetails));// Finally add items to array list
                }
